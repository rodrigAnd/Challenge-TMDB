...
class MovieDetailViewModelTest {
    ...
    @Test
    fun `loadMovieDetails should emit Loading then Success when details are loaded`() = runTest {
        // Given
    ...
    @Test
    fun `loadMovieDetails should emit Error when useCase fails`() = runTest {
        // Given
    ...
    @Test
    fun `resetState should reset to Loading`() = runTest {
        // Given
        val movieDetail = createMovieDetail(1, "Movie 1")
        coEvery { getMovieDetailsUseCase(1) } returns Result.success(movieDetail)
