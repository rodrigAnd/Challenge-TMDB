...
class MovieListFragment : Fragment() {
    ...
    private fun navigateToErrorConnection() {
        val intent = android.content.Intent(requireContext(), com.onboarding.mychallenge.presentation.error.ErrorConnectionActivity::class.java)
        intent.flags = android.content.Intent.FLAG_ACTIVITY_NEW_TASK or android.content.Intent.FLAG_ACTIVITY_CLEAR_TASK
        startActivity(intent)
        activity?.finish()
    }
    private fun navigateToError(message: String) {
        val intent = android.content.Intent(requireContext(), com.onboarding.mychallenge.presentation.error.ErrorActivity::class.java)
